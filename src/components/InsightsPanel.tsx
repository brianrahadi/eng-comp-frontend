      ...
      {summary && (
        <div className="grid grid-cols-2 gap-3 mb-4">
          ...
          <div className="bg-[#334155] rounded p-3 border border-[#475569]">
            ...
            <div className="text-lg font-bold text-[#FBBF24]">{parseFloat(summary.avgLightOverall).toFixed(3)}</div>
          </div>
        </div>
      )}
            ...
            {averages.slice(-5).map((avg, idx) => (
              <div key={idx} className="bg-[#334155] rounded p-2 text-xs border border-[#475569]">
                ...
                <div className="text-[#CBD5E1] mt-1">
                  ...
                  Light: {parseFloat(avg.avgLight).toFixed(3)} | 
                  CameraLight: {parseFloat(avg.avgCameraLight).toFixed(1)}
                </div>
              </div>
            ))}
          </div>

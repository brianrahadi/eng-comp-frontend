  ...
  return (
    <div className="rounded border border-[#334155] bg-[#1E293B] p-3 shadow-lg text-sm min-w-[200px] text-[#F8FAFC]" style={{ boxShadow: "0 4px 6px rgba(56, 189, 248, 0.2)" }}>
      ...
      <div className="space-y-1">
        <div>
          <span className="font-medium text-[#CBD5E1]">Criticality:</span>{" "}
          <span
            style={{ color: getCriticalityColor(criticality.criticalityLevel) }}
        ...
        {criticality.overrideTriggered && (
          <div className="text-xs text-[#EF4444] mt-1">
            ⚠ Override: {criticality.overrideReason}
          </div>
        )}
        {cam.ViewDescription && (
